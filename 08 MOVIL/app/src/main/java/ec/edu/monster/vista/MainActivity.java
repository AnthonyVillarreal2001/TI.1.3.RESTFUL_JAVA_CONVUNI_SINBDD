...
import ec.edu.monster.controller.RestClient;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void realizarConversion() {
        ...
        // Determinar endpoint REST según selección
        ...
        convertir(path, valor, unidadResultado);
    }

    private void convertir(String path, String valorStr, String unidad) {
        new Thread(() -> {
            try {
                float valor = Float.parseFloat(valorStr);
                float resultado = RestClient.callConversion(path, valor);
                runOnUiThread(() -> {
